...
switch ($env) {
    ...
    case 'testing-foo-non-headless':
        $searchFor = 'View_Foo_UnitCest.php';

        break;
    case 'testing-bar':
    case 'testing-bar-non-headless':
        $searchFor = 'View_Bar_UnitCest.php';
    ...
    case 'testing-lall-non-headless':
        $searchFor = 'View_Lall_UnitCest.php';
    ...
    default:
        ...
        switch (YOUR_SYSTEM_NAME) {
            ...
            case 'testing-lall-non-headless':
                ...
                break;
            default:
                $searchFor = 'View_Default_UnitCest.php';
...
$searchForGlobal = '_GLOBAL_UnitCest.php';
$testViewFiles = array();
...
$codeceptCliCommand = 'thirdparty/codecept_php55.phar ' . $debug . ' ' . $coverage . ' --env="' . $env . '" run unit';
